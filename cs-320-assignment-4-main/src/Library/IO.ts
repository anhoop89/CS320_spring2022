...
export const prettyPrintName = (name: string): HTMLElement => {
...
export const prettyPrintNode = (tree: Expr | Stmt): HTMLElement => {
  ...
  switch (tree.tag) {
    ...
    case "not":
      ...
      break;
    case "conditional":
      rootElement.setAttribute("data-name", "conditional");
      rootElement.appendChild(prettyPrintNode(tree.condition));
      rootElement.appendChild(prettyPrintNode(tree.trueExpr));
      rootElement.appendChild(prettyPrintNode(tree.falseExpr));
      break;
    case "num":
    ...
    case "if":
      ...
      break;
    case "for":
      rootElement.setAttribute("data-name", `for(${tree.name})`);
      rootElement.appendChild(prettyPrintNode(tree.initialExpr));
      rootElement.appendChild(prettyPrintNode(tree.condition));
      rootElement.appendChild(prettyPrintNode(tree.update));
